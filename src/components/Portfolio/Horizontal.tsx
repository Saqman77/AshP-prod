      ...
      <div className="h-grid">
        ...
        <section className='outro'>
            ...
            <span className='outro-span'>
                ...
                Since 2003, Ash P Reads Editing Services has contributed their expertise to over 200 fiction and nonfiction manuscripts, along with extensive website and social media content. Founded by Ash P, this family-run editing service has collaborated with best-selling authors and an award-winning publisher. 
                <span className='space'></span>
                Ash has a particular expertise in working with ESL authors, helping bring structure to their stories and developing their individual writing voices.
                <span className='space'></span>
                Hira has extensive knowledge of neurodivergence and this gives her a unique insight when&nbsp;working with manuscripts on related subjects. Both editors bring valuable backgrounds in early childhood education and special education, making them well suited for manuscripts related to children and education.
