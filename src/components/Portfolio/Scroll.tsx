            ...
            <div className="panel-right">
              <div className="qualification-wrapper">
                <div className="qual-section">
                  <h3 className="cert-heading">Certifications & Courses</h3>
                  <ul className="cert-list">
                    <li id="list1">
                      <p className="cert-text">Digital Marketing</p>
                    </li>
                    <li id="list2">
                      <p className="cert-text">Freelancing</p>
                    </li>
                    <li id="list3">
                      <p className="cert-text">Video Editing</p>
                    </li>
                    <li id="list4">
                      <p className="cert-text">Graphic Design</p>
                    </li>
                    <li id="list5">
                      <p className="cert-text">Communication & Soft Skills</p>
                    </li>
                    <li id="list6">
                      <p className="cert-text">Creative Writing</p>
                    </li>
                    <li id="list7">
                      <p className="cert-text">Digital Literacy</p>
                    </li>
                    <li id="list7">
                      <p className="cert-text">AI in Teaching</p>
                    </li>
                    <li id="list7">
                      <p className="cert-text">
                        Google Soft Skills Certification
                      </p>
                    </li>
                    <li id="list7">
                      <p className="cert-text">Pathways to Publishing</p>
                    </li>
                    <li id="list7">
                      <p className="cert-text">AI for Editors</p>
                    </li>
                  </ul>
                </div>
                <div className="qual-section2">
                  <h3 className="q-heading">Qualifications</h3>
                  <ul className="cert-list2">
                    <li id="list1">
                      <p className="q-text">
                        B.A. in Mass Communication, English Literature, and
                        Education.
                      </p>
                    </li>
                  </ul>
        ...
        <div className="panel-front">
          ...
          <div className="panel-bio">
            <p className="bio">
              <span>
                <span>
                  Ash P brings over two decades of experience in literary
                  editing across diverse genres and online content. Known among
                  peers as "the book surgeon", she specializes in safe-for-work
                  nonfiction and fiction for all ages.
                </span>
                ...
                <span>
                  Ash is a volunteer editor for #RevPit, a verified editor on
                  IAX, and as a member of the Comic Book Editors Alliance, she
                  is being mentored in comic book editing. She is an active
                  participant in several supportive social spaces and networks
                  for&nbsp;editors&nbsp;like the Neurodivergent Publishing
                  Lounge and the Editors' Lair on Discord, and the Editors Tea
                  Club and EFA BIPOC Chapter on Slack.
                </span>
                ...
                <span>
                  A self-proclaimed logophile, lexophile, and librocubicularist,
                  Ash is often reading, networking, or learning a new skill in
                  her free time.
                </span>
              </span>
            </p>
              ...
              <div className="qualification-wrapper">
                <div className="qual-section">
                  ...
                  <ul className="cert-list">
                    <li id="list1">
                      <p className="cert-text">
                        Certification in UCL Leadership development program
                      </p>
                    </li>
                    <li id="list2">
                      <p className="cert-text">
                        Certificate in professional studies in education from
                        Bradford College (an associate college of the University
                        of Bradford)
                      </p>
                    </li>
                    <li id="list3">
                      <p className="cert-text">APTIS C1 English Proficiency</p>
                    </li>
                    <li id="list4">
                      <p className="cert-text">
                        Special Ed training at PAIIExAKU-IED, and HumQadam
                        Foundation
                      </p>
                    </li>
                    <li id="list5">
                      <p className="cert-text">
                        Multiple Microsoft certifications, including Microsoft
                        Innovative Educator
                      </p>
                    </li>
                    <li id="list6">
        ...
        <div className="panel-front">
          <div className="panel-bio">
            <p className="bio">
              <span>
                <span>
                  Hira P brings 30 years of experience as an educationist and
                  four years as an editorial professional, specializing in
                  proofreading and beta reading, including a year of
                  copyediting.
                </span>
                ...
                <span>
                  Her professional journey includes extensive experience in
                  curriculum design, and teacher training, which has honed her
                  ability to communicate effectively and adapt to the diverse
                ...
                <span>
                  This has led Hira to have a passion for language and a keen
                  eye for detail. She is committed to delivering excellence and
                  helping clients achieve their vision through well-crafted
                  written materials. Hira P is a verified reader on IAX.
                </span>
              </span>
            </p>
            <div className="members">
