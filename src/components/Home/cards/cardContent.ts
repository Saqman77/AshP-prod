export const cardContent = [
...

    {
      ...
      backgroundColor: "#E9B50080",
      description: "Typos hiding in plain sight? Punctuation playing tricks?\n\nOur proofreading service ensures your manuscript is as error-free as is humanly possible. Only the Creator is perfect!\n\nOur Proofreading Service includes Annotations and edits with Tracked Changes.\n\nRates are determined by your budget and the word count. "
    },
    {
      id: "Reader Services",
      ...
      backgroundColor: "#F0195B33",
      description: "Does your manuscript need a Beta Reader? Maybe you require a Sensitivity or Authenticity Reader?\n\nOur team of readers can help you.\n\nRates are determined by the health of the manuscript, your  budget, and the word count. "
    },
    {
      id: "Other services",
      ...
      backgroundColor: "#7163DE80",
      description: "Need an Urdu to English translation? Transcribing or Subtitles?\n\nDrop us a line and ask us what else we can do. We got you!"
    },
  ];