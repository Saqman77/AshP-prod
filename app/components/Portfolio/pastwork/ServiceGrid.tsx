...
const ServiceGrid: React.FC<ServiceGridProps> = ({ isVisible, service, start, end, close, next, last, currentIndex: mainIndex, length }) => {
  ...
  const filteredGenres =
    activeFilter === 'All'
      ? [...service.genres.Fiction ? service.genres.Fiction : [] , ...service.genres.Nonfiction ? service.genres.Nonfiction : []]
      : activeFilter === 'Fiction'
      ? service.genres.Fiction ? service.genres.Fiction : []
      : service.genres.Nonfiction ? service.genres.Nonfiction : [];
