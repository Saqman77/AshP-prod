...
const FreedieSlider: React.FC<FreedieSliderProps> = ({ onItemClick, viewMode, setViewMode, onScrollPositionChange, freedie }) => {
    ...
    const [, setInitialScrollPosition] = useState<number | null>(null);
    ...
    }, { scope: containerRef, dependencies: [isReady, freedie] }); // Scope the animations to the entire container and refresh when ready
    ...
    return (
        <div className="slider-container" ref={containerRef}>
            ...
            <div className="slider">
                ...
                {freedie && freedie.map((member, idx) => {
                    ...
                    return (
                        ...
                        >
                            <div className="slide-img">
                                <Image width={800} height={1024} src={member.imgSrc.url} alt={member.name} />
                            </div>
